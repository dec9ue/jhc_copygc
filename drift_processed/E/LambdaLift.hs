...
declEnv_u f r@S{declEnv  = x} = r{declEnv = f x}
funcName_u f r@S{funcName  = x} = r{funcName = f x}
isStrict_u f r@S{isStrict  = x} = r{isStrict = f x}
topVars_u f r@S{topVars  = x} = r{topVars = f x}
declEnv_s v =  declEnv_u  (const v)
funcName_s v =  funcName_u  (const v)
isStrict_s v =  isStrict_u  (const v)
topVars_s v =  topVars_u  (const v)
