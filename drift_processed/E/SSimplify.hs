...
envCachedSubst_u f r@Env{envCachedSubst  = x} = r{envCachedSubst = f x}
envInScope_u f r@Env{envInScope  = x} = r{envInScope = f x}
envInScopeCache_u f r@Env{envInScopeCache  = x} = r{envInScopeCache = f x}
envRules_u f r@Env{envRules  = x} = r{envRules = f x}
envSubst_u f r@Env{envSubst  = x} = r{envSubst = f x}
envCachedSubst_s v =  envCachedSubst_u  (const v)
envInScope_s v =  envInScope_u  (const v)
envInScopeCache_s v =  envInScopeCache_u  (const v)
envRules_s v =  envRules_u  (const v)
